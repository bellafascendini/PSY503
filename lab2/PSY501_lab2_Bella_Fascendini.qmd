...
-   produce a dataframe that has not just mean of x, but also the following summary statistics in appropriately named columns: -- mean of y -- median of x -- median of y -- variance of x -- variance of y -- correlation between x and y (found using the *cor()*)
